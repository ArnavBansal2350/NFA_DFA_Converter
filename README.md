...
- **Step 1** → Introduction page with NFA & DFA definitions and examples
- **Step 2** → Define your NFA (states, symbols, start state, final states)
- **Step 3** → Fill in the NFA transition table interactively
- **Step 4** → Step-by-step Subset Construction explanation
- **Step 5** → Auto-generated DFA transition table using Subset Construction
- **Step 6** → Side-by-side visualization of NFA and DFA graphs
...
4. View step-by-step Subset Construction explanation
5. View the generated DFA transition table
6. Click **Visualize Graphs** to see both NFA and DFA diagrams side by side
7. Use the 🔍 magnifier button to zoom and explore graphs
---
